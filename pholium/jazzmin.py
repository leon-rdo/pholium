...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": _("Welcome to the Pholium"),
    # Copyright on the footer
    "copyright": f"Pholium © {datetime.now().year} - Leonardo Costa",
    ...
    "icons": {
        ...
        "content.ContentBlock": "fas fa-th-large",
        "content.NavigationItem": "fas fa-compass",
        "content.Testimonial": "fas fa-comment",
